        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-between">
                <div class="w-full md:w-1/3 mb-6 md:mb-0">
                    <h3 class="text-2xl font-bold mb-4">Art & Culture</h3>
                    <p class="text-gray-400">Explorez le monde de l'art et de la culture à travers nos articles passionnants.</p>
                </div>
                <div class="w-full md:w-1/3 mb-6 md:mb-0">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="index.php?page=login" class="text-gray-400 hover:text-white transition-colors">Connexion</a></li>
                        <li><a href="index.php?page=register" class="text-gray-400 hover:text-white transition-colors">Inscription</a></li>
                    </ul>
                </div>
            ...
            <div class="mt-8 border-t border-gray-700 pt-8 text-center text-gray-400">
                <p>&copy; <?php echo date('Y'); ?> Plateforme Art et Culture. CREATED BY HICHAM OUBAHA.</p>
            </div>
        </div>
    </footer>
</body>
