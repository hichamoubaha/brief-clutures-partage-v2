    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="flex items-center justify-between mt-8">
            <?php if ($userData['role'] !== 'admin'): ?>
                ...
                <!-- Ban/Unban Button -->
                <?php if ($userData['role'] === 'banned'): ?>
                    <a href="index.php?page=unban_user&id=<?php echo $userData['id_utilisateur']; ?>" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Débannir l'utilisateur
                    </a>
                <?php else: ?>
                    <a href="index.php?page=ban_user&id=<?php echo $userData['id_utilisateur']; ?>" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
