  ...
  <div class="p-6">
      ...
      <form action="index.php?page=register" method="POST" enctype="multipart/form-data">
          <div class="mb-4">
              ...
              <input type="text" id="nom_utilisateur" name="nom_utilisateur" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
          </div>
          <div class="mb-4">
          ...
          <div class="mb-6">
              <label for="photo" class="block text-gray-700 text-sm font-bold mb-2">Photo de profil</label>
          ...
          <div class="flex items-center justify-between">
              ...
              <a href="index.php?page=login" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                  Déjà inscrit ?
              </a>
          </div>
      </form>
